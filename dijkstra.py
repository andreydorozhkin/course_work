...
class Dijkstra:
    ...
    @staticmethod
    def execute_alg(wg: WeightedGraph[V], root: V) -> Tuple[List[Optional[float]], Dict[int, WeightedEdge]]:
    ...
    def distance_array_to_vertex_dict(self, wg: WeightedGraph[V], distances: List[Optional[float]]) -> Dict[
        V, Optional[float]]:
